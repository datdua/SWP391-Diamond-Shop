...
<<<<<<< HEAD:Front-End/thediamondstore-demo-firebase/src/pages/LoginRegister/LoginRegisterPage.js
    const accountID = useParams();
=======
    const accountId = useParams();
>>>>>>> main:Front-End/thediamondstore/src/pages/LoginRegister/LoginRegisterPage.js
    ...
    return (
        <div>
            <div id="wrapper" className="wrapper">
                <div className="tm-breadcrumb-area tm-padding-section bg-grey" style={{ backgroundImage: `url(https://firebasestorage.googleapis.com/v0/b/the-diamond-store-423602.appspot.com/o/img-banner%2Fimg-banner-dang-nhap.png?alt=media&token=8005f781-7956-444b-92c9-fe5c20a5df31)` }}>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6">
                                    <form onSubmit={handleLogin} className="tm-form tm-login-form">
                                        <h4>Đăng Nhập</h4>
                                ...
                                <div className="col-lg-6">
                                    <form onSubmit={handleRegister} className="tm-form tm-register-form">
                                        <h4>Tạo tài khoản</h4>
