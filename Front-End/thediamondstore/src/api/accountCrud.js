...
export async function getAllAccount() {
  const response = await axios.get(
    "http://localhost:3000/api/accounts/accounts"
  );
...
export async function getAccountByID_AdminManager(accountID) {
  try {
    ...
    const response = await axios.get(
      `http://localhost:3000/api/accounts/get/${accountID}`,
      {
...
export async function getAccountByID(accountID) {
  ...
  try {
    const token = localStorage.getItem('jwt');
    const response = await axios.get(
      `http://localhost:3000/api/customers/customer/${accountID}`,{
        headers: {
...
export async function getAccountHaveNotRoleCustomer() {
  try {
    const token = localStorage.getItem('jwt');
    const response = await axios.get(
      `http://localhost:3000/api/accounts/all-except-customer`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export async function getAccountByRoleCustomer() {
  try {
    const token = localStorage.getItem('jwt');
    const response = await axios.get(
      `http://localhost:3000/api/accounts/getByRole/ROLE_CUSTOMER`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export async function updateAccount(accountID, accountDetails) {
  ...
  try {
    const response = await axios.put(
      `http://localhost:3000/api/accounts/customer/update/${accountID}`,
      accountDetails,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export async function updateProfile(accountID, accountDetails) {
  ...
  try {
    const response = await axios.put(
      `http://localhost:3000/api/customers/customer/update/${accountID}`,
      accountDetails,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export async function deleteAccounts(accountIDs) {
  try {
    const token = localStorage.getItem("jwt");
    const response = await axios.delete("http://localhost:3000/api/accounts/admin/delete", {
      headers : { Authorization: `Bearer ${token}` },
      data: accountIDs,
    });
    return response.data;
...
export const getContactInfo = async (accountId) => {
  const token = localStorage.getItem('jwt')
  try {
    const response = await axios.get(`http://localhost:3000/api/accounts/customer/contactInfo/${accountId}`,{
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
...
export const getAccountIDByEmail = async (email) => {
  try {
    const token = localStorage.getItem("jwt");
    const response = await axios.get(
      `http://localhost:3000/api/accounts/customer/getByEmail/${email}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const getCustomerPoints = async (accountId) => {
  const token = localStorage.getItem('jwt')
  try {
    const response = await axios.get(`http://localhost:3000/api/customers/customer/${accountId}`,{
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
...
export const resetPassword = async (email) => {
  try {
    const response = await axios.post(`http://localhost:3000/api/accounts/guest/forget-password?email=${email}`,
    );
    return response.data;
  } catch (error) {
...
export const setPassword = async (email, newPassword) => {
  try {
    const response = await axios.put(`http://localhost:3000/api/accounts/guest/set-password?email=${encodeURIComponent(email)}`, {}, {
      headers: {
...
export const countCustomer = async () => {
  try {
    const response = await axios.get(`http://localhost:3000/api/customers/total`,
    );
    return response.data;
  } catch (error) {
...
export const countRevenue = async () => {
  try {
    const response = await axios.get(`http://localhost:3000/api/orders/totalOrderPaid`,
    );
    return response.data;
  } catch (error) {
...
export const regenerateOTP = async (email) => {
  try {
    ...
    const response = await axios.put(
      `http://localhost:3000/api/accounts/guest/regenerate-otp`,
