    ...
    <div>
      <div id="wrapper" className="wrapper">
        <div
          ...
          style={{
            backgroundImage: `url(https://firebasestorage.googleapis.com/v0/b/the-diamond-store-423602.appspot.com/o/img-banner%2Fimg-banner2.png?alt=media&token=13ceeebc-e94b-4e57-95d7-ec5dbb2fa30e)`,
          }}
        >
                        ...
                        <div className="col-lg-6 col-md-6 col-12">
                          <div className="tm-prodetails-contents">
                            ...
                            <span className="tm-prodetails-price">
                              {diamond.diamondEntryPrice.toLocaleString()} VND
                            </span>
