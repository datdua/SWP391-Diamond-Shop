...
public class SecurityConfig {
    ...
    private static final String[] WHITE_LIST_URL = { "/api/v1/auth/**", "/v2/api-docs", "/v3/api-docs",
			...
			"/api/test/**", "/authenticate", "/login", "/register", "/home" };

    private static final String[] ADMIN_URL = { "/accounts", "/update/**", "/diamond/**" };

    private static final String[] CUSTOMER_URL = { "/accounts", "/update/**"};
