        ...
        <Container fluid>
            ...
            <Row>
                <Col md={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h4">Account List</Card.Title>
                        </Card.Header>
                        <Card.Body>
                                    ...
                                    <tbody>
                                        {accounts.map((account) => (
                                            <tr key={account.accountID}>
                                                ...
                                                <td>{account.role}</td>
                                                <td>
                                                    <Button variant="primary" size="sm" onClick={() => handleShowUpdate(account)}>Edit</Button>
                                                    <Button variant="danger" size="sm" onClick={() => handleShowDeleteModal(account)}>Delete</Button>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
            ...
            <Modal show={showModal} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>{isUpdating ? 'Update Account' : 'Add Account'}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {isUpdating ? (
            ...
            <Modal show={showDeleteModal} onHide={handleCloseDeleteModal}>
                ...
                <Modal.Body>
                    <DeleteAccountForm accountID={selectedAccount.accountID} onDelete={() => handleDeleteAccount(selectedAccount.accountID)} />
                </Modal.Body>
            </Modal>
        </Container>
    );
