  ...
  return (
    <Form onSubmit={handleSubmit}>
      <Form.Group>
        ...
        <Form.Control type="text" name="diamondID" value={updatedJewelry.diamondID} onChange={handleChange} />
      </Form.Group>
      <Form.Group>
        <Form.Label>Jewelry Name</Form.Label>
        <Form.Control type="text" name="jewelryName" value={updatedJewelry.jewelryName} onChange={handleChange} />
      </Form.Group>
      <Form.Group>
        <Form.Label>Gender</Form.Label>
        <Form.Control type="text" name="gender" value={updatedJewelry.gender} onChange={handleChange} />
      </Form.Group>
      <Form.Group>
        <Form.Label>Size</Form.Label>
        <Form.Control type="text" name="size" value={updatedJewelry.size} onChange={handleChange} />
      </Form.Group>
      <Form.Group>
        <Form.Label>Jewelry Image</Form.Label>
        <Form.Control type="text" name="jewelryImage" value={updatedJewelry.jewelryImage} onChange={handleChange} />
      </Form.Group>
